...
public class PagerSlidingTabStrip extends HorizontalScrollView implements View.OnClickListener {
    ...
    private boolean isAllowDivider ;
    private int barColor =  0xFF666666;
    ...
    private void init() {
		...
		barHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, barHeight, dm);
	...
	public void setAllowDivider(boolean isAllowDivider) {
		this.isAllowDivider = isAllowDivider;
	}
