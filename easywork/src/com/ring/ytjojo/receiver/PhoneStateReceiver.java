...
//				SharedPreferences sp = SharePreferenceUtil.getSPbyName("config", context);
//				
//				int count = sp.getInt("ringRecieved", 0);
//				count ++;
//				sp.edit().putInt("ringRecieved", count);
//				sp.edit().commit();
//				Log.i("Receiver", "ring count" + count);
//				boolean ison = sp.getBoolean("ringon", false);
//				if(!ison)
//				{
//					return;
//				}
