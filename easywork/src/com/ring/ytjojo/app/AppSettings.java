...
import com.ring.ytjojo.UI.SettingsActivity;
...
public class AppSettings {
	...
	public void refresh(String preferenceKey) {
		...
		Boolean displayUrl = mSharedPreferences.getBoolean(
				SettingsActivity.KEY_DISPLAY_URL_PREFERENCE,
				DEFAULT_DISPLAY_URL);
	...
	public int getCacheSize() {
		String value = mSharedPreferences.getString(
				SettingsActivity.KEY_CACHE_SIZE_PREFERENCE, DEFAULT_CACHE_SIZE);
	...
	public boolean isAutoRefreshEnabled() {
		return mSharedPreferences.getBoolean(
				SettingsActivity.KEY_AUTO_REFRESH_PREFERENCE,
				DEFAULT_AUTO_REFRESH);
	}

	public boolean isShowNotificationsEnabled() {
		String notificationTime = mSharedPreferences.getString(
				SettingsActivity.KEY_NOTIFICATION_TIME_PREFERENCE,
	...
	public Uri getRingtoneUri() {
		String uri = mSharedPreferences.getString(
				SettingsActivity.KEY_RINGTONE_PREFERENCE, null);
		if (uri == null) {
			return null;
		}
	...
	public String getNotificationType() {
		return mSharedPreferences.getString(
				SettingsActivity.KEY_NOTIFICATION_TYPE_PREFERENCE,
