package com.ring.ytjojo.util.OS;
import java.io.File;
...
import com.ring.ytjojo.util.Logger;
...
public final class SystemTool {
    ...
    public static String getSign(Context context, String pkgName) {
        try {
           ...
           Logger.xLog().e(SystemTool.class.getName() + "the "
    ...
    public static int gc(Context cxt) {
        ...
        Logger.xLog().d("清理了" + (getDeviceUsableMemory(cxt) - i)
                + "M内存");
        return count;
    }
}