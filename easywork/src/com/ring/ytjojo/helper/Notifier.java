...
import com.ring.ytjojo.receiver.AlarmReceiver;
import com.ring.ytjojo.receiver.DeleteNotificationsReceiver;
...
public class Notifier {
    ...
    public static void cancel(Context context, String accountKey, String type) {
        ...
        edit.putInt(Constants.NOTIFICATION_COUNT + accountKey + type, 0);
        edit.putString(Constants.NOTIFICATION_SUMMARY + accountKey + type, "");
        edit.commit();
    ...
    public static void saveLastNotificationActioned(Context context, String accountKey, String type, long postId) {
        ...
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        String pref = type.equals(Constants.NOTIFICATION_TYPE_MENTION) ? Constants.NOTIFICATION_LAST_ACTIONED_MENTION_ID : Constants.NOTIFICATION_LAST_ACTIONED_DIRECT_MESSAGE_ID;
    ...
    private static void saveLastNotificationDisplayed(Context context, String accountKey, String type, long postId) {
        ...
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        String pref = type.equals(Constants.NOTIFICATION_TYPE_MENTION) ? Constants.NOTIFICATION_LAST_DISPLAYED_MENTION_ID : Constants.NOTIFICATION_LAST_DISPLAYED_DIRECT_MESSAGE_ID;
        long lastDisplayedMentionId = preferences.getLong(pref + accountKey, 0);
    ...
    public static void setDashclockValues(Context context, String accountKey, String type, int count, String detail) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor edit = preferences.edit();
        edit.putInt(Constants.NOTIFICATION_COUNT + accountKey + type, count);
        edit.putString(Constants.NOTIFICATION_SUMMARY + accountKey + type, detail);
        edit.commit();
    }
}
